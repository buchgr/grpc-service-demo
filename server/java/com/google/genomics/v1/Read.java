...
public  final class Read extends
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    result = result && getId()
        .equals(other.getId());
    result = result && getReadGroupId()
        .equals(other.getReadGroupId());
    result = result && getReadGroupSetId()
        .equals(other.getReadGroupSetId());
    result = result && getFragmentName()
        .equals(other.getFragmentName());
    result = result && (getProperPlacement()
        == other.getProperPlacement());
    result = result && (getDuplicateFragment()
        == other.getDuplicateFragment());
    result = result && (getFragmentLength()
        == other.getFragmentLength());
    result = result && (getReadNumber()
        == other.getReadNumber());
    result = result && (getNumberReads()
        == other.getNumberReads());
    result = result && (getFailedVendorQualityChecks()
        == other.getFailedVendorQualityChecks());
    result = result && (hasAlignment() == other.hasAlignment());
    if (hasAlignment()) {
      result = result && getAlignment()
          .equals(other.getAlignment());
    }
    result = result && (getSecondaryAlignment()
        == other.getSecondaryAlignment());
    result = result && (getSupplementaryAlignment()
        == other.getSupplementaryAlignment());
    result = result && getAlignedSequence()
        .equals(other.getAlignedSequence());
    result = result && getAlignedQualityList()
        .equals(other.getAlignedQualityList());
    result = result && (hasNextMatePosition() == other.hasNextMatePosition());
    if (hasNextMatePosition()) {
      result = result && getNextMatePosition()
          .equals(other.getNextMatePosition());
    }
