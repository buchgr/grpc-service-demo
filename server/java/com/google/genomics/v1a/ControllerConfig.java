...
public  final class ControllerConfig extends
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    result = result && getCmd()
        .equals(other.getCmd());
    result = result && getGcsLogPath()
        .equals(other.getGcsLogPath());
    result = result && getMachineType()
        .equals(other.getMachineType());
    result = result && internalGetVars().equals(
        other.internalGetVars());
    result = result && internalGetDisks().equals(
        other.internalGetDisks());
    result = result && internalGetGcsSources().equals(
        other.internalGetGcsSources());
    result = result && internalGetGcsSinks().equals(
