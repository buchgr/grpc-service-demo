...
@javax.annotation.Generated(
    ...
    comments = "Source: google/cloud/ml/v1/prediction_service.proto")
public class OnlinePredictionServiceGrpc {

  private OnlinePredictionServiceGrpc() {}

  public static final String SERVICE_NAME = "google.cloud.ml.v1.OnlinePredictionService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.google.cloud.ml.api.v1.PredictRequest,
      com.google.api.HttpBody> METHOD_PREDICT =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "google.cloud.ml.v1.OnlinePredictionService", "Predict"),
          io.grpc.protobuf.ProtoUtils.marshaller(com.google.cloud.ml.api.v1.PredictRequest.getDefaultInstance()),
  ...
  public static abstract class OnlinePredictionServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void predict(com.google.cloud.ml.api.v1.PredictRequest request,
    ...
    @java.lang.Override public io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.cloud.ml.api.v1.PredictRequest,
  ...
  public static final class OnlinePredictionServiceBlockingStub extends io.grpc.stub.AbstractStub<OnlinePredictionServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.api.HttpBody predict(com.google.cloud.ml.api.v1.PredictRequest request) {
  ...
  public static final class OnlinePredictionServiceFutureStub extends io.grpc.stub.AbstractStub<OnlinePredictionServiceFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.api.HttpBody> predict(
        com.google.cloud.ml.api.v1.PredictRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PREDICT:
          serviceImpl.predict((com.google.cloud.ml.api.v1.PredictRequest) request,
              (io.grpc.stub.StreamObserver<com.google.api.HttpBody>) responseObserver);
          break;
        default:
