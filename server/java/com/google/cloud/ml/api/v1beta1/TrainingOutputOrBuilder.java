...
public interface TrainingOutputOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.ml.v1beta1.TrainingOutput)
   ...
   */
  java.util.List<com.google.cloud.ml.api.v1beta1.HyperparameterOutput> 
      getTrialsList();
  /**
   * <pre>
   * Results for individual Hyperparameter trials.
   ...
   * <code>repeated .google.cloud.ml.v1beta1.HyperparameterOutput trials = 2;</code>
   */
  com.google.cloud.ml.api.v1beta1.HyperparameterOutput getTrials(int index);
  /**
   * <pre>
   * Results for individual Hyperparameter trials.
   * Only set for hyperparameter tuning jobs.
   ...
   * <code>repeated .google.cloud.ml.v1beta1.HyperparameterOutput trials = 2;</code>
   */
  java.util.List<? extends com.google.cloud.ml.api.v1beta1.HyperparameterOutputOrBuilder> 
   ...
   * <code>repeated .google.cloud.ml.v1beta1.HyperparameterOutput trials = 2;</code>
   */
  com.google.cloud.ml.api.v1beta1.HyperparameterOutputOrBuilder getTrialsOrBuilder(
      int index);
